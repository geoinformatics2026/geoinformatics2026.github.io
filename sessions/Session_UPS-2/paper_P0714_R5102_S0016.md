...
exports:
  - format: pdf
    template: arxiv_nips
    output: pdf/paper_P0714_R5102_S0016.pdf
---
...
Semantic Tags: population mapping; high-resolution population distribution; deep learning; multi-source geospatial data; population spatialization; spatial data fusion; regional demography; Yangtze River Economic Belt; China


```{admonition} Presentation Information
:class: note

**Submission ID:** P0714_R5102_S0016  
